...
const FootballTeamOrganiser = (props) => {
  ...
  const addPlayerFunct = (position, player) => {    
      ...
      <section className = {styles.infoContainer}>
        <div className = {styles.positionList}>
          ...
          <div className = {styles.playerList}>
            <h3>Players</h3>
            {footballers.map(player => {
            return <button onClick = {() => addPlayerFunct(player.position, player.name)}> Add {player.name} to Team</button>          
            })
          }
        </div>
      </section>
